...
| Variable | Default | Purpose |
|---|---|---|
| `OWNSUITE_MTA_RELAY_HOST` | `mail.infomaniak.com:587` | The EU SMTP relay outbound mail is sent through (`host:port`, STARTTLS). |
...
| `OWNSUITE_MTA_SPF_INCLUDE` | `spf.infomaniak.ch` | The relay's SPF include, published in the SPF TXT record. |
